    ...
    if ( ! class_exists( 'ReduxFramework_extension_customizer' ) ) {
        ...
        class ReduxFramework_extension_customizer {
            ...
            public function _register_customizer_controls( $wp_customize ) {
                ...
                {
                    include_once trailingslashit( get_template_directory() ).'admin/redux-framework/inc/extensions/customizer/inc/customizer_section.php';
                    if ( method_exists( $wp_customize, 'register_section_type' ) ) {
                        $wp_customize->register_section_type( 'Redux_Customizer_Section' );
                    }
                }
                if ( ! class_exists( 'Redux_Customizer_Panel' ) ) {
                    include_once trailingslashit( get_template_directory() ).'admin/redux-framework/inc/extensions/customizer/inc/customizer_panel.php';
                ...
                if ( ! class_exists( 'Redux_Customizer_Control' ) ) {
                    include_once trailingslashit( get_template_directory() ).'admin/redux-framework/inc/extensions/customizer/inc/customizer_control.php';
                }

                include_once trailingslashit( get_template_directory() ).'admin/redux-framework/inc/extensions/customizer/inc/customizer_fields.php';
                include_once trailingslashit( get_template_directory() ).'admin/redux-framework/inc/extensions/customizer/inc/customizer_devs.php';
            ...
            public function _enqueue_previewer() {
                ...
                $localize = array(
                    'save_pending'   => esc_html__( 'You have changes that are not saved. Would you like to save them now?', 'primestudio' ),
                    'reset_confirm'  => esc_html__( 'Are you sure? Resetting will lose all custom values.', 'primestudio' ),
                    'preset_confirm' => esc_html__( 'Your current options will be replaced with the values of this preset. Would you like to proceed?', 'primestudio' ),
                            ...
                            if ( isset( $field['type'] ) ) {
                                ...
                                if ( ! class_exists( $field_class ) ) {
                                    ...
                                    if ( $class_file ) {
                                        ...
                                        $file_path=dirname($class_file);
                                        $file_name=basename($class_file);
