...
// ############################################################################
            ...
            if ( ! $url ) {
                ...
                $args = array(
                    'user-agent' => isset( $_GET['user_agent'] ) ? $_GET['user_agent'] : filter_input(INPUT_SERVER, 'HTTP_USER_AGENT'),
                    'method'     => 'GET',
                );
            ...
            if ( isset( $_GET['mode'] ) && $_GET['mode'] == 'native' ) {
                ...
                $is_xhr = !empty( filter_input(INPUT_SERVER, 'HTTP_X_REQUESTED_WITH') ) ? strtolower( filter_input(INPUT_SERVER, 'HTTP_X_REQUESTED_WITH') ) : 'xmlhttprequest';
                ...
                $ret = $jsonp_callback ? "$jsonp_callback($json)" : $json;
                printf('%s',$ret);
