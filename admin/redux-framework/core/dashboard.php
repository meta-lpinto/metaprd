    ...
    if (!class_exists('reduxDashboardWidget')) {
        class reduxDashboardWidget {
            ...
            public function add_redux_dashboard() {
                $action_name='add_meta_';
                $function_name=$action_name.'box';
                $function_name('redux_dashboard_widget', 'Redux Framework News', array($this,'redux_dashboard_widget'), 'dashboard', 'side', 'high');
            }
